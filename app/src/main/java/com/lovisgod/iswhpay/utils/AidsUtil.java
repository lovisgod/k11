...
public class AidsUtil {
    ...
    private static List<AidEntity> generateAids(){
        ...
        // LOCAL PROP CARDS
        AidEntity appProp1 = new AidEntity.Builder()
                .AID("A0000005550101")
                .selFlag(0)
                .appVersion("0096")
                .DDOL("9F3704")
                ...
                .threshold(100)
                .build();
        aidEntityList.add(appProp1);

        AidEntity appProp2 = new AidEntity.Builder()
                .AID("A0000004440101")
                .selFlag(0)
                .appVersion("0001")
                .DDOL("9F3704")
                ...
                .threshold(100)
                .build();
        aidEntityList.add(appProp2);

        AidEntity appProp3 = new AidEntity.Builder()
                .AID("A0000004939002")
                .selFlag(0)
                .appVersion("0001")
                .DDOL("9F3704")
...
//    private static List<CapkEntity> generatePropCardsProductionCapks() {
//        List<CapkEntity> capkEntityList =new ArrayList<>();
//        // MasterCard Production Capk
//        CapkEntity capkProp0x00 = CapkEntity.builder()
//                .RID("A000000371")
//                .capkIndex(0x03)
//                .arithInd(0x01)
//                .hashInd(0x01)
...
//                .checkSum("319F3C608B67F1118C729B0E1516EAB07CB290C8")
//                .build();
//        capkEntityList.add(capkProp0x00);
//
//        CapkEntity capkVerve0x01 = CapkEntity.builder()
//                .RID("A000000371")
//                .capkIndex(0x06)
