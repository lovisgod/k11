...
public class TripleDES {
    ...
    public static String decrypt(String pan, String encryptedPin, String pinKey) throws Exception {
        byte[] tmp = h2b(pinKey);
        byte[] key = new byte[24];
        System.arraycopy(tmp, 0, key, 0, 16);
        System.arraycopy(tmp, 0, key, 16, 8);
        ...
        System.out.println("pin decoded ::::" + decryptedMessage);
        String pinEncoded = b2h(plaintext);
        System.out.println("pin encoded ::::" + pinEncoded);
    ...
    public static String decodePinBlock(String pan, String pinEncoded) throws Exception {
        ...
        return b2h(pinBlock).substring(2, 4 + 2);
    }
